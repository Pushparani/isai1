...
<td width="551"><a href="http://www.imayam.org"><img src="/isai/songs/design/smartlink.jpg" width="551" height="78" border="0" alt=""></a></td>
<td width="100%">&nbsp;</td>
...
<a href="http://www.tkqlhce.com/click-1922339-166277" target="_blank" onmouseover="window.status='http://www.registryweb.com/';return true;" onmouseout="window.status=' ';return true;">
<img src="http://www.tqlkg.com/image-1922339-166277" width="88" height="31" alt="Register Discount Domain Names At RegistryWeb" border="0"></a>

<BR><BR><BR>
<a href="http://www.anrdoezrs.net/click-1922339-10371512" target="_blank" onmouseover="window.status='http://affiliates.ebay.com';return true;" onmouseout="window.status=' ';return true;">
<img src="http://www.awltovhc.com/image-1922339-10371512" width="120" height="240" alt="" border="0"></a>
</div>
			</td>
		</tr>
	</table>
				...
				<form action="controller" method="post">
					...
					<table align="center">
						<tr>
							...
							<h1>SmartLinks Login</h1>
							<div style="color:red;text-align:center;"><c:out value="${sessionScope.message}" /></div>
							</td>
						<tr>
						<tr>
							<td><div style="font-weight: bold;text-align:right;">Login</div></td>
							<td><input type="text" name="login" maxlength="25" size="30"></td>
						</tr>
						<tr>
							<td><div style="font-weight: bold;text-align:right;">Password</div></td>
							<td><input type="password" name="password" maxlength="25" size="30"></td>
						</tr>
						<tr>
						    <td></td>
						...
						<tr><td colspan="2"><a href="/home/imayam2/public_html/forum/profile.php?mode=register">Register for SmartLink</a> | 
						<a href="/home/imayam2/public_html/forum/profile.php?mode=sendpassword">Forgot password?</a></td></tr>
						<tr><td colspan="2">Use the same login/password, if registered with any of the imayam services.</td></tr>						
					</table>
				</form>
			</td>
		</tr>
