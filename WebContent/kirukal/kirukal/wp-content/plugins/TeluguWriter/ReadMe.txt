Telugu Writer 1.1 by Monusoft
http://www.monusoft.com/Products/WordPressPlugin/tabid/187/Default.aspx

Easily write post/page/comment in Telugu with easy-to-use Telugu transliterate keyboard. No need of Telugu IME. 

--------------------------------------------------------------

Features:

    * Easily write post/page/comment in Telugu.
    * No need to learn Telugu typing.
    * Easy inline editing of post in Telugu.
    * Switch to normal english keyboard by pressing F12 or selecting "English" radio button.
    * Extremely fast Telugu typing.
    * It's all magic of Javascript.

Plugin Installation:

   1. Unzip/upload to /plugins directory.
   2. Plug-in file path will become "wp-content/plugins/TeluguWriter/TeluguWriter.php"
...
Version History:
   ...
   1.1	Release Date : 6 Nov, 2006
	...
	Changed name of plugin from Telugu Comment Writer to Telugu Writer to reflect broader functionality.
	Added support of Telugu Type Pad in editing post and page
	Removed bug of Javascript error for logged in user writing comment.

   1.0	Release Date: 5 Nov, 2006
	Plug-in developed for writing comment in Telugu.
...
Wanna chat in Telugu on yahoo messenger / google talk?
