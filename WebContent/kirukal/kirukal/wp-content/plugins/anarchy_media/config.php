...
$youtubeheightD = '350';		// Height of your YouTube player
...
// Myspace options
$myspacewidthD ='430';		// Width of your Myspace player
$myspaceheightD = '346';		// Height of your Myspace player
// AtomFilms options
$atomwidthD ='426';		// Width of your AtomFilms player
$atomheightD = '350';		// Height of your AtomFilms player
// Break options
$breakwidthD ='425';		// Width of your Break player
$breakheightD = '350';		// Height of your Break player
// Revver options
$revverwidthD = '480';
$revverheightD = '376';
$revverIDD = '44205';
...
if(get_option('anarchy_wysiwyg')) : $wysiwyg = get_option('anarchy_wysiwyg');
else : $wysiwyg = 'false';
endif;
...
// AtomFilms options
if(get_option('anarchy_atomwidth')) : $atomwidth = get_option('anarchy_atomwidth');
else : $atomwidth = $atomwidthD; 
endif;
if(get_option('anarchy_atomheight')) : $atomheight = get_option('anarchy_atomheight');
else : $atomheight = $atomheightD;
endif;
// Break options
