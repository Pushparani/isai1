Kannada Writer 1.1 by Monusoft
http://www.monusoft.com/Products/WordPressPlugin/tabid/187/Default.aspx

Easily write post/page/comment in Kannada with easy-to-use Kannada transliterate keyboard. No need of Kannada IME. 

--------------------------------------------------------------

Features:

    * Easily write post/page/comment in Kannada.
    * No need to learn Kannada typing.
    * Easy inline editing of post in Kannada.
    * Switch to normal english keyboard by pressing F12 or selecting "English" radio button.
    * Extremely fast Kannada typing.
    * It's all magic of Javascript.

Plugin Installation:

   1. Unzip/upload to /plugins directory.
   2. Plug-in file path will become "wp-content/plugins/KannadaWriter/KannadaWriter.php"
...
Version History:
   ...
   1.1	Release Date : 6 Nov, 2006
	...
	Changed name of plugin from Kannada Comment Writer to Kannada Writer to reflect broader functionality.
	Added support of Kannada Type Pad in editing post and page
	Removed bug of Javascript error for logged in user writing comment.

   1.0	Release Date: 5 Nov, 2006
	Plug-in developed for writing comment in Kannada.
...
Wanna chat in Kannada on yahoo messenger / google talk?
