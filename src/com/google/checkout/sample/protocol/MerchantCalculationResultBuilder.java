...
public class MerchantCalculationResultBuilder 
  ...
  public CouponResult createCouponResult(boolean isCodeValid, 
    ...
    try {
      CouponResult cResult 
        = _objectFact.createResultMerchantCodeResultsTypeCouponResult();
   ...
   * @version 1.2
   */
  public Document createMerchantCalResultsByGiftCert(
   ...
   * @version 1.2
   */
  public Document createMerchantCalResultsByCoupon(
