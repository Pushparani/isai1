...
public class CallBackParserTest extends TestCase {
  ...
  private String mCalXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" + 
      "<merchant-calculation-callback " +
      " xmlns=\"http://checkout.google.com/schema/2\" " +
      "   serial-number=\"85afb1fe-e00d-4eca-990c-6ab48bec612e\">\n" + 
      "   <shopping-cart>\n" + 
      "     <merchant-private-data><ml-data><orderID>1197701</orderID>" +
      "       <customerID>1516701</customerID></ml-data>\n" + 
      "     </merchant-private-data>\n" + 
      "     <items>\n" + 
      "       <item>\n" + 
      "         <quantity>1</quantity>\n" + 
      "         <unit-price currency=\"USD\">185.0</unit-price>\n" + 
      "         <item-name>Bela Eyelet Cami</item-name>\n" + 
      "         <item-description>Bela Eyelet Cami</item-description>\n" + 
      "         <merchant-private-item-data>" +
      "           <ml-data>" +
      "             <sku>8888798603</sku>" +
      "               <orderDetailId>101601</orderDetailId>" + 
      "           </ml-data>" +
      "         </merchant-private-item-data>" + 
      "       </item>\n" + 
      "     </items>\n" + 
      "   </shopping-cart>\n" + 
      "   <buyer-id>950794670252537</buyer-id>\n" + 
      "   <calculate>\n" + 
      "     <addresses>\n" + 
      "       <anonymous-address id=\"948409835188669\">\n" + 
      "         <country-code>US</country-code>\n" + 
      "         <city>petaluma</city>\n" + 
      "         <region>CA</region>\n" + 
      "         <postal-code>94954</postal-code>\n" + 
      "       </anonymous-address>\n" + 
      "     </addresses>\n" + 
      "     <merchant-code-strings />\n" + 
      "     <tax>false</tax>\n" + 
      "     <shipping>\n" + 
      "       <method name=\"Standard Service\" />\n" + 
      "       <method name=\"3 Day Select\" />\n" + 
      "       <method name=\"2nd Day Air\" />\n" + 
      "       <method name=\"Next Day Air\" />\n" + 
      "       <method name=\"Gift Card Ground\" />\n" + 
      "     </shipping>\n" + 
      "   </calculate>\n" + 
  ...
  private MerchantCalculationEventHandler _merCalHandler;
  ...
  protected void setUp() throws Exception {
    ...
    _merCalHandler = new MerchantCalculationEventHandler();
    ...
    _handler.addCallBackListener(_merCalHandler);
  }
  ...
  public void testRemoveCallBackListenerChargebackListener() throws Exception {
    int beforeRemove 
      = _handler.getListenerSize(ChargebackNotificationEvent.class);
  ...
  public void testRemoveCallBackListenerNewOrderListener() throws Exception {
    int beforeRemove 
      = _handler.getListenerSize(NewOrderNotificationEvent.class);
   ...
   * This method then verifies that the listener was properly added.
   */
  public void testAddCallBackListenerOrderStatusChangedListener() 
      throws Exception {
    int beforeAdd 
      = _handler.getListenerSize(OrderStateChangeNotificationEvent.class);
   ...
   * This method then verifies that the listener was properly removed.
   */
  public void testRemoveCallBackListenerOrderStatusChangedListener() 
      throws Exception {
    int beforeRemove 
      = _handler.getListenerSize(OrderStateChangeNotificationEvent.class);
  ...
  public void testAddCallBackListenerRiskAlertListener() throws Exception {
    int beforeAdd 
      = _handler.getListenerSize(RiskInformationNotificationEvent.class);
  ...
  private class ChargebackEventHandler extends CallBackEventHandler 
    ...
    public void handleEvent(CallBackEvent event) {
      ChargebackNotificationEvent chargeBackEvent 
        = (ChargebackNotificationEvent) event;
  ...
  private class OrderStatusEventHandler extends CallBackEventHandler
    ...
    public void handleEvent(CallBackEvent event) {
      OrderStateChangeNotificationEvent statusEvent 
        = (OrderStateChangeNotificationEvent) event;
  ...
  private class RiskAlertEventHandler extends CallBackEventHandler
    ...
    public void handleEvent(CallBackEvent event) {
      RiskInformationNotificationEvent riskEvent 
        = (RiskInformationNotificationEvent) event;
      RiskInformationNotification riskNote = riskEvent.getRiskNote();
      assertNotNull(riskNote.getClass());
    }
  }
  
  private class MerchantCalculationEventHandler extends CallBackEventHandler
      implements MerchantCalculationCallbackListener {
    public void handleEvent(CallBackEvent event) {
      MerchantCalculationCallbackEvent merchantCalEvent
        = (MerchantCalculationCallbackEvent) event;
      MerchantCalculationCallback merchantCal
        = merchantCalEvent.getMerchantCalculationNote();
      assertEquals("85afb1fe-e00d-4eca-990c-6ab48bec612e",
        merchantCal.getSerialNumber());
      String testData 
        = (String)merchantCal.getShoppingCart()
          .getMerchantPrivateData().getAny();
      String originalData = "<ml-data><orderID>1197701</orderID>" +
        "<customerID>1516701</customerID></ml-data>";
